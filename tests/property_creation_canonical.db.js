...
/* ════════════════════════════════════════════════════════════════════
   ...
   C  IDENTITY — the best behaviour of each door, kept
      ...
      C8  dealintake's teach-on-creation now serves every door
   ...
   tests/property_creation_http.db.js, which runs the real Express stack.

   run:  HARNESS_DATABASE_URL="postgres://..." node tests/property_creation_canonical.db.js
   ════════════════════════════════════════════════════════════════════ */
"use strict";
