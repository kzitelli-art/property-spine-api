...
(async()=>{
 ...
 try {
  ...
  assert(dated.units.length>0,'nonempty informational inventory exercises the selection boundary');
  assert(dated.units.every(u=>u.selection_eligible===false));
