...
//  rather than from a claim: lease_packets.js writes lease_packets,
...
//
//  Run: DATABASE_URL=... node tests/proofs/slice9_lease_packet_proof.js
// ════════════════════════════════════════════════════════════════════
...
const pkSrc = fs.readFileSync(path.join(REPO, "src/applications/lease_packets.js"), "utf8");
...
ok(!distinct.includes("leases"), `lease_packets.js writes NO lease (writes: ${distinct.join(", ")})`);
