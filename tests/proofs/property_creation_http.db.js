...
/* ════════════════════════════════════════════════════════════════════
   ...
   H8  deal_intake still teaches aliases and re-resolves its files

   run:  HARNESS_DATABASE_URL="postgres://..." node tests/proofs/property_creation_http.db.js
   ════════════════════════════════════════════════════════════════════ */
"use strict";
...
function buildApp() {
  ...
  app.use("/", require("../../src/money/bank_intake.js")({ pool }));
  app.use("/", require("../../src/surfaces/owner.js")({ pool }));
  app.use("/", require("../../src/onboarding/deal_intake.js")({
    pool,
...
(async () => {
  ...
  //  Two files on one intake, both labelled — deal_intake's teach + resolve.
  await pool.query(
  ...
  ok("H8a deal_intake still teaches its observed labels and re-resolves its files",
