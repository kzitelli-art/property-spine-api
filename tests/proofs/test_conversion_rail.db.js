...
const buildModule = require("../../src/leasing/leasing_conversion.js");
// THE CLOSURE AUTHORITY. leasing_conversion.js fails CLOSED without it
// (leasing_conversion.js:35-37) — and this harness was not passing it, so it
...
async function main() {
  ...
  await T("4b · ineligible actual host → attribution kept, obligation honestly UNASSIGNED, no invented owner", async () => {
    ...
    //  present semantics of this field are UNRESOLVED. leasing_conversion.js:274
