...
/* ════════════════════════════════════════════════════════════════════
   ...
   run:  HARNESS_DATABASE_URL="postgres://..." node tests/proofs/authority_mutation_containment.db.js
   ════════════════════════════════════════════════════════════════════ */
"use strict";
...
const { databaseSsl } = require("../../src/shared/database_ssl.js");
...
function buildApp() {
  ...
  const staffBridgeService = require("../../src/identity/staff_bridge.js")({ pool })._service;
  app.use("/", require("../../src/identity/team_access.js")({
    pool,
