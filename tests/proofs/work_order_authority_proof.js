...
//  RUN:  DATABASE_URL=... node tests/proofs/work_order_authority_proof.js
// ════════════════════════════════════════════════════════════════════
"use strict";
...
const tenantLinkModule = require("../../src/comms/tenant_link.js");
...
async function main() {
  ...
  ok("G2. tenant_link refuses too — a silently dead resident route is worse than a failed boot",
