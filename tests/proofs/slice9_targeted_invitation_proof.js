...
//  resolution.
//
//  Run: DATABASE_URL=... node tests/proofs/slice9_targeted_invitation_proof.js
...
(async () => {
  ...
  try {
    ...
    const mod = require(path.join(REPO, "src/applications/application_submission"))({
    ...
    const fs = require("fs");
    const src = fs.readFileSync(path.join(REPO, "src/applications/application_submission.js"), "utf8");
