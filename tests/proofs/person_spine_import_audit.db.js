/* ════════════════════════════════════════════════════════════════════
   ...
   from leasing_leads.js resolveOrCreatePerson).
...
//  The canonical intake keys, replicated EXACTLY from leasing_leads.js
...
(async () => {
  ...
  try {
    ...
    say("      -> these queues exist and are written ONLY by leasing_shadow_import.js.");
