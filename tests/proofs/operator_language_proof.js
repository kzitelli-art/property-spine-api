...
//
//    node tests/proofs/operator_language_proof.js
//
...
section("2  the Accept button still calls the Build 3 canonical service");
{
  ...
  //  deliberately, and that change is asserted in tests/proofs/release_candidate_proof.js.
...
section("8  no migration and no domain table change is introduced");
{
  ...
  const ALLOWED = [
    ...
    "src/surfaces/unit_turn.js", "tests/proofs/work_acceptance_proof.js",
    ...
    "tests/proofs/work_proof_photo_proof.js", "tests/proofs/unit_turn_page_proof.js", "tests/proofs/staff_agent_proof.js",
  ];
