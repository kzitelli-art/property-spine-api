...
(async () => {
  ...
  // like nothing. tests/proofs/test_conversion_rail.db.js was in exactly that state
  // for 204 commits: leasing_conversion.js fails closed without a closure
  ...
  {
    const build = require(path.join(__dirname, "../../src/leasing/leasing_conversion.js"));
