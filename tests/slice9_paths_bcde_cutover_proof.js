/* ══════════════════════════════════════════════════════════════════════════
   ...
   authority:
     ...
     C  applicationSubmission.js deny         → declined|withdrawn|expired
   ...
   Run: DATABASE_URL=... node tests/slice9_paths_bcde_cutover_proof.js
   ══════════════════════════════════════════════════════════════════════════ */
"use strict";
...
(async () => {
  ...
  const subRouter = require("../src/applications/applicationSubmission.js")({
