/* ══════════════════════════════════════════════════════════════════════════
   ...
   authority instead of their own raw SQL:
     ...
     applicationSubmission.js  submitApplicationService  (public + internal)
   ...
   Run: DATABASE_URL=... node tests/slice9_path_a_birth_cutover_proof.js
   ══════════════════════════════════════════════════════════════════════════ */
"use strict";
...
(async () => {
  ...
  app.use("/", require("../src/applications/applicationSubmission.js")({
  ...
  try {
    ...
    // ══════════════════════════════════════════════════════════════
    section("D  applicationSubmission.js door — internal submit");
    ...
    const svc = require("../src/applications/applicationSubmission.js")({
    ...
    brokenApp.use("/", require("../src/applications/applicationSubmission.js")({
      pool,
    ...
    const fs = require("fs");
    const raw = ["src/applications/applications.js", "src/applications/applicationSubmission.js"]
