...
//  receipt composition, extracted out of src/comms/tenantlink.js into
...
const TL_SRC = read("src/comms/tenantlink.js");
...
// ════════════════════════════════════════════════════════════════════
{
  ...
  ok("tenantlink IMPORTS the receipt seam and CALLS all three composers",
...
// ════════════════════════════════════════════════════════════════════
{
  ...
  ok("tenantlink's pending-clarification query is still NOT keyed on obligations.person_id",
...
// ════════════════════════════════════════════════════════════════════
{
  ...
  ok("tenantlink REFUSES to proceed on a refused receipt, rolling the claim back",
