...
exec env -i PATH="$PATH" HOME="$HOME" \
  ...
  LEASING_INTAKE_SECRET="e2e-intake" LEASING_INTAKE_PROPERTY_IDS="$PROP${E2E_INTAKE_INACTIVE_PROPERTY_ID:+,$E2E_INTAKE_INACTIVE_PROPERTY_ID}" \
  PROSPECT_ACTIVATION_PROPERTY_IDS="${E2E_PROSPECT_ACTIVATION_PROPERTY_IDS:-}" \
