-- Contracted Services canonical truth - unnumbered release candidate.
--
-- This file deliberately lives outside migrations until coordination assigns
-- the next ledger number. The numbered migration must be byte-for-byte this
-- payload plus its migration header.
