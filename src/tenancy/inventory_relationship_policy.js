...
const POLICY = Object.freeze([
  ...
  // Reviewed source identity decisions preserve their selected targets as
  // lineage. They do not establish a new tenancy or operative attachment.
  { table: "proposed_records", column: "selected_unit_id", treatment: L, label: "source identity decision" },
  { table: "proposed_records", column: "selected_space_id", treatment: L, label: "source identity decision" },
