/* ════════════════════════════════════════════════════════════════════
   ...
   already cheap: a handful of capital-stack positions per property, not
   a schedule derivation.
   ...
   4125's real equity positions, once retained documents exist to
   establish them from, land through a narrow controlled step — not
   through this file. This file stays read-only and boring.
...
module.exports = function equityRoutes(deps) {
  ...
  router.get("/operator/equity/standing", gate, async (req, res) => {
    ...
    try {
      ...
      //  no established capital-stack position is a legitimate, complete
