 ...
 * leasingscheduling.js module. This adapter should call the existing scheduling
...
const { ingestSchedulingSourceEvent } = require('./schedulingAdapterSeam');
