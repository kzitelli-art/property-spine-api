'use strict';
// ════════════════════════════════════════════════════════════════════
//  SCHEDULING ADAPTER SEAM — schedulingAdapterSeam.js
//
//  The ONE translation point between the Outlook/Acuity adapter and the
//  canonical scheduling service (leasingscheduling.js, migration 048).
//
//  The adapter (outlookAcuitySync.js) reads Graph mail and produces a raw
...
const buildSchedulingModule = require('../leasing/leasingscheduling');
