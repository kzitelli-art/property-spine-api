// ============================================================
// money_board.js — THE MONEY BOARD (read-only, migration 044-aware)
//
...
// bank_bridge bridge-auto) and the mechanism is invisible without a read.
...
//   const moneyBoardModule = require('./money_board');
//   app.use('/', moneyBoardModule({ pool }));
// ============================================================

module.exports = function money_board(deps) {
  const express = require("express");
  const router = express.Router();
  const { pool } = deps;
  if (!pool) throw new Error("money_board module requires a pool");
