// ════════════════════════════════════════════════════════════════════
//  LEASING LEAD INTAKE — leasing_leads.js  (re-rooted onto persons)
//
...
//
//  Deps mirror tenant_link.js: { pool, anthropic, INGEST_MODEL, sms }.
...
module.exports = function leasingLeadsModule({ pool, anthropic, INGEST_MODEL, sms, leasingLifecycle, conversionServices, commitmentLedger = null, commBoundary }) {
  ...
  // (application_submission.js, lease_packets.js, tenant_link.js).
  ...
  //  bridge (staff_bridge.js) remains a SEPARATE identity fact and does NOT route
  //  through here.
  //
  //  Lookup order:
  ...
  //    spawns a second thread. Mirrors the tenant-line upsert in tenant_link.js
