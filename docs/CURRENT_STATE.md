...
**September 13 QB integration candidate — not released:** this isolated tree combines source-home review at `f5dbc7e` (exact full CI 504 / 34764246154 succeeded) with reviewed inventory correction at `a0177f6` (exact full CI 505 / 34764374824 succeeded), retaining the existing two-step leasing candidate. The inventory relationship policy explicitly classifies migration 196's selected unit/space decision references as source lineage; migration 197's operative attachment rules remain unchanged. All 56 source-governance gates pass on the combined working source. Combined catalog/HTTP/browser acceptance and release remain open. No production migration, source confirmation, property retirement or customer action occurred. A separate canonical rent safeguard and Management leaf navigation fix are still being built and are not included in this checkpoint.

**Current live correction:** API remains `dab19b6`; app `4ba519471fb6451784d42d4c05018375ed76dde3` is verified live. Management and its full Rent Roll use the same dated canonical reader and show Skyline's 160 positions across 72 units in the actual owner session. No legacy rent average, forward occupancy inference or balance fallback is presented as live. This is signed-in read acceptance, not Mike's login or full property launch. Workspace receipt: `handoffs/new-hp/MANAGEMENT_RELEASE_20260913.md`.
